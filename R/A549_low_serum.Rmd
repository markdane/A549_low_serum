...
```{r cell_cycle_figures, fig.width = 12, fig.height=5, eval = FALSE}
...
```{r KRT5_gating_figures, fig.width = 12, fig.height=5}
...
colNames <- c("Barcode","ArrayRow","ArrayColumn","ECMp","Ligand","Spot_PA_SpotCellCount","Cytoplasm_GT_KRT5_MeanIntensity","Cytoplasm_GT_KRT19_MeanIntensity")
...
dt <- l2[l2$Ligand %in% c("BMP2", "IFNG","TGFB1||Cterminus","TGFB1||LAP", "OSM", "TNF","IGFBP3|1")&l2$ECMp=="COL1",]
